...
def get_image_dir(args):
    ...
    print('weights_iteration: %d' % (weights_iteration,))
...
def main():
    ...
    # parser.add_argument('--test_boxes', type=str)
    ...
    # args.weights= './output/lstm_rezoom_lung_2016_12_13_17.39/save.ckpt-1000000'
    # hypes_file = './hypes/lstm_rezoom_lung.json'
    with open(hypes_file, 'r') as f:
        H = json.load(f)
    expname = args.expname + '_' if args.expname else ''
    # args.test_boxes = './data/lung_data/lung_test.json'
    # print('test_load')
